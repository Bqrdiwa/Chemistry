...
function init() {
	...
	for ( var i = 0, l = objects.length; i < l; i ++ ) {
		...
		object.position.x = radui* Math.cos( theta ) * Math.sin( phi );
		object.position.y = radui * Math.sin( theta ) * Math.sin( phi );
		object.position.z = radui * Math.cos( phi );
