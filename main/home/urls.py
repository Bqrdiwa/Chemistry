...
from .views import Home,  Announcement,usersList,Solution_view,informationBank,Solution_Not_Answered, Solution_Question_view, Question_view, Plans_view, Question_bank,virtualExamPage,  VirtualExam, virtualExamResultQuestions
...
urlpatterns = [
    ...
    path('users-list/',usersList,name= 'announcment'),
